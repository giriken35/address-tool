      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 sm:p-12 shadow-sm">
          ...
          <div className="prose prose-sm sm:prose-base prose-slate dark:prose-invert max-w-none space-y-6">
            ...
            <section>
              <h2 className="text-lg font-semibold text-foreground mt-8 mb-4">第3条（アップロードされたデータの取り扱い）</h2>
              <p>本サービスにおいてユーザーがアップロードしたCSVファイル等に含まれる住所等のデータは、正規化およびジオコーディング処理の目的にのみ使用され、処理完了後に当社のサーバーから速やかに破棄されます。当社がこれらのデータを永続的に保存、蓄積、または第三者に提供することはありません。</p>
            </section>
