...
const faqs = [
  ...
  {
    question: "法人契約や請求書払い（銀行振込）には対応していますか？",
    answer: (
      <div className="space-y-4">
        <p>はい、対応しております。法人契約でお支払いを銀行振込にされる場合、毎月の「振込手数料」の御社ご負担や、毎月の「経費精算の手間」を最小限に抑えるため、大変ご好評いただいている【年間一括払い：60,000円（税込）】にて承っております。</p>
        <p>ご希望の際は、下部のお問い合わせフォームより「プロプラン（API）のご利用相談」を選択してご連絡ください。御社の指定期日やフォーマットに合わせた請求書を発行いたします。</p>
      </div>
    )
  }
]
