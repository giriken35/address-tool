...
export function StickyHeader() {
  ...
  return (
    ...
    >
      <div className="flex w-full max-w-5xl items-center justify-between rounded-2xl border border-border/40 bg-surface/20 px-4 py-3 shadow-lg backdrop-blur-xl">
