      ...
      <div className="rounded-3xl border border-border bg-gradient-to-br from-surface to-card p-6 sm:p-12 shadow-xl relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="rounded-2xl border border-border bg-background/60 p-6 sm:p-8 backdrop-blur-md flex flex-col items-center shadow-inner relative">
            ...
            {/* 入力 */}
            <div className="w-full max-w-[280px] rounded-xl bg-gradient-to-r from-card to-surface border border-border p-4 text-center text-sm sm:text-base font-bold text-foreground shadow-md flex items-center justify-center gap-2 transition-transform hover:scale-105">
            ...
            <div className="flex flex-col items-center my-3">
              ...
              <div className="whitespace-nowrap rounded-full border border-border bg-surface px-4 py-1.5 text-xs sm:text-sm font-bold text-foreground shadow-sm flex items-center gap-1.5 z-10">
            ...
            <div className="w-full max-w-[340px] relative rounded-2xl border-2 border-brand/50 bg-gradient-to-b from-brand/10 to-transparent p-6 text-center shadow-[0_0_30px_-5px_rgba(108,99,255,0.25)] mt-2">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-brand text-white px-4 py-1 rounded-full text-xs sm:text-sm font-black shadow-md whitespace-nowrap flex items-center gap-1.5">
                <Zap className="h-3.5 w-3.5 fill-white" /> メモリ上の揮発処理エリア
              </div>
              
              <div className="flex justify-center gap-3 mt-4 mb-5">
                <div className="flex items-center gap-1.5 rounded-lg bg-background/80 backdrop-blur px-3 py-2 text-xs sm:text-sm font-bold text-foreground shadow-sm border border-border">
              ...
              <div className="relative inline-flex items-center justify-center w-full">
                ...
                <div className="relative flex items-center justify-center gap-1.5 text-xs sm:text-sm sm:text-base font-black text-red-600 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/50 py-2 px-3 rounded-lg shadow-sm w-full">
            ...
            <div className="flex flex-col items-center my-3">
              <div className="w-[2px] h-6 bg-brand/30"></div>
              <div className="whitespace-nowrap rounded-full border border-border bg-surface px-4 py-1.5 text-xs sm:text-sm font-bold text-muted-foreground shadow-sm z-10">
                処理件数(ログ)のみ記録
              </div>
              <div className="w-[2px] h-6 bg-brand/30"></div>
              <div className="w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[8px] border-t-brand/30"></div>
            ...
            <div className="w-full max-w-[280px] rounded-xl bg-gradient-to-r from-surface to-card border border-border p-4 flex items-center justify-center gap-2 text-sm sm:text-base font-bold text-foreground shadow-md transition-transform hover:scale-105">
